...
#SBATCH --output=/home/csgrad/sjin075/logs/convert3.txt  # logging per job and per host in the current directory. Both stdout and stderr are logged.
...
--dst_folder /data/HangQiu/data/multicorrupt/dark/3 \
--severity 3 \
--n_cpus 8
...
--root_folder /data/HangQiu/data/nuscenes \
--dst_folder /data/HangQiu/data/multicorrupt/beamsreducing/3 \
--severity 3 \
--n_cpus 8

...
if __name__ == '__main__':
    ...
    if 'infos' in train_infos:
        # mmdetection3d 1.4
        all_infos.extend(update_pathes(train_infos['infos']))
    elif 'data_list' in train_infos:
        all_infos.extend(update_pathes_dev1x(train_infos['data_list']))
    else:
    ...
    if 'infos' in val_infos:
        all_infos.extend(update_pathes(val_infos['infos']))
    elif 'data_list' in val_infos:
        all_infos.extend(update_pathes_dev1x(val_infos['data_list']))
    else:
        exit("This mmdetection3d version is not supported.")

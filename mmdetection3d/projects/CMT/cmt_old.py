...
class CmtOldDetector(MVXTwoStageDetector):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(CmtOldDetector, self).__init__(**kwargs)
    ...
    def init_weights(self):
        ...
        super(CmtOldDetector, self).init_weights()
    ...
    def extract_pts_feat(self, voxel_dict):

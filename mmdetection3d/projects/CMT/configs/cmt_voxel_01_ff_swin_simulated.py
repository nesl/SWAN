...
custom_imports = dict(
    imports=['projects.BEVFusion.bevfusion','projects.nucarsim.nusim', 'projects.UniM2AE', 'projects.CMT'], allow_failed_imports=False)
...
val_evaluator = dict(
    ...
    metric='bbox',
    custom_splits_file= data_root + 'sim_nuscenes.py',
    backend_args=backend_args)

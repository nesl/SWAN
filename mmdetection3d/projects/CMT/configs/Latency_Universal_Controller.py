...
model = dict(
    ...
    use_grid_mask=True,
    controller = dict(
        type='Latency_Universal_Controller',
        layer_budgets=[5, 10, 14, 19] # This is actually in terms of latencies
...
# runtime settings
train_cfg = dict(by_epoch=True, max_epochs=16, val_interval=33)
val_cfg = dict()
test_cfg = dict()
...
param_scheduler = [
    dict(
        ...
        end_factor=0.001,       # Gradually decay to 10% of the LR
        by_epoch=True,
...
resume=False
load_from= '/workspace/mmdetection3d/work_dirs/cmt_train_all_corruptions/epoch_8.pth'
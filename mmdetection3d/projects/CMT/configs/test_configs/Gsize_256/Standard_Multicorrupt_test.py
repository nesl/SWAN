...
dataset_type = 'NuScenesCorruptSplitDataset'
...
corruption = 'DUMMY'  # 'fog', 'snow', 'temporalmisalignment', 'brightness', 'dark', 'missingcamera', 'motionblur', None
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        lidar_corruption=corruption,
        camera_corruption=corruption,

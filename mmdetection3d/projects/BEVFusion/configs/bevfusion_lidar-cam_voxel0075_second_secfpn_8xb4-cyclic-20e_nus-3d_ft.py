...
custom_imports = dict(
    imports=['projects.BEVFusion.bevfusion', 'projects.CMT'], allow_failed_imports=False)
...
custom_hooks = [
   dict(type='FreezeLayersHookBEV', train_module_names=['bbox_head'])
]
...
resume=False
load_from= '/workspace/mmdetection3d/projects/BEVFusion/bevfusion_fixed.pth'
# load_from= '/workspace/mmdetection3d/projects/BEVFusion/bevfusion_lidar-cam_voxel0075_second_secfpn_8xb4-cyclic-20e_nus-3d-5239b1af.pth'

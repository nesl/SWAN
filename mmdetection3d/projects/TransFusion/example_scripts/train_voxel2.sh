...
#SBATCH --output=/data/HangQiu/proj/mlsys/DynMMOT_scripts/transfusion/logs/transfusion_VLC.txt 
...
WORKDIR=/data/HangQiu/proj/mlsys/DynMMOT_scripts/transfusion/work_dir/transfusion_voxel_LC

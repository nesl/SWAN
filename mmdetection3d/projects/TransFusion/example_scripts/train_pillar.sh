...
#SBATCH --output=/data/HangQiu/proj/mlsys/DynMMOT_scripts/transfusion/logs/transfusion_PL.txt 
...
WORKDIR=/data/HangQiu/proj/mlsys/DynMMOT_scripts/transfusion/work_dir/transfusion_lidar
export PORT=$((29500 + RANDOM % 1000))

CFG=/data/HangQiu/proj/mlsys/DynMMOT/mmdetection3d/projects/TransFusion/configs/transfusion_nusc_pillar_L.py

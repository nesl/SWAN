...
#SBATCH --output=/data/HangQiu/proj/mlsys/DynMMOT_scripts/transfusion/logs/transfusion_PLC.txt 
...
WORKDIR=/data/HangQiu/proj/mlsys/DynMMOT_scripts/transfusion/work_dir/transfusion_pillar_LC
export PORT=$((29500 + RANDOM % 1000))

CFG=/data/HangQiu/proj/mlsys/DynMMOT/mmdetection3d/projects/TransFusion/configs/transfusion_nusc_pillar_LC.py
...
bash tools/dist_train.sh \
    ...
    --cfg-options  \
        ...
        "train_dataloader.num_workers=20" \

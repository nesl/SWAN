...
train_pipeline = [
    ...
    dict(
        ...
        rot_range=[-0.3925 * 2, 0.3925 * 2],  # kept original voxel rotation range
    ...
    # Pack3DDetInputs replaces DefaultFormatBundle3D + Collect3D
    dict(
...
# Replaced data dict with separate dataloader dicts
...
# Replaced optimizer/optimizer_config with optim_wrapper 
optim_wrapper = dict(
    type='OptimWrapper',
...
# Replaced total_epochs with train_cfg 
train_cfg = dict(by_epoch=True, max_epochs=20, val_interval=5)
val_cfg = dict()
test_cfg = dict()
log_processor = dict(window_size=50)

# Replaced checkpoint_config/log_config with default_hooks 
default_hooks = dict(

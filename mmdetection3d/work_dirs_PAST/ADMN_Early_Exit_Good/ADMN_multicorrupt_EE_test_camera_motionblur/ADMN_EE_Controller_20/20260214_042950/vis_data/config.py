...
model = dict(
    camera_early_exit_model=dict(type='Early_Exit_Camera'),
    ...
    lidar_early_exit_model=dict(type='Early_Exit_Lidar'),
    pts_backbone=dict(
...
work_dir = './work_dirs/ADMN_multicorrupt_EE_test_camera_motionblur/ADMN_EE_Controller_20'

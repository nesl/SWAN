...
launcher = 'none'
load_from = '/workspace/mmdetection3d/work_dirs/ADMN_20_early_exit/epoch_8.pth'
log_level = 'INFO'
...
model = dict(
    camera_early_exit_transformer=dict(
        num_layers=1,
        ...
        transformerlayers=dict(
            ...
            with_cp=False),
        type='EarlyExitTransformerDecoder'),
    controller=dict(layer_budget=20, type='ConvLayerController'),
    ...
    lidar_early_exit_transformer=dict(
        num_layers=1,
        return_intermediate=False,
        transformerlayers=dict(
            attn_cfgs=[
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        box_type_3d='LiDAR',
        camera_corruption='camera_motionblur',
        corruption_root='/workspace/mmdetection3d/data/multicorrupt',
        data_prefix=dict(
            CAM_BACK='samples/CAM_BACK',
            CAM_BACK_LEFT='samples/CAM_BACK_LEFT',
            ...
            sweeps='sweeps/LIDAR_TOP'),
        data_root='/workspace/mmdetection3d/data/nuscenes/',
        lidar_corruption='camera_motionblur',
        metainfo=dict(classes=[
            'car',
            'truck',
            'construction_vehicle',
...
work_dir = './work_dirs/ADMN_multicorrupt_EE_test_camera_motionblur/ADMN__EE_Controller_20'

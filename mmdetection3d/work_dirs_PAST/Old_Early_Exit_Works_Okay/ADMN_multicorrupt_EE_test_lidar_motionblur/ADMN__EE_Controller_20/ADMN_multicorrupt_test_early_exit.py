...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        box_type_3d='LiDAR',
        camera_corruption='lidar_motionblur',
        corruption_root='/workspace/mmdetection3d/data/multicorrupt',
        data_prefix=dict(
            CAM_BACK='samples/CAM_BACK',
            CAM_BACK_LEFT='samples/CAM_BACK_LEFT',
            ...
            sweeps='sweeps/LIDAR_TOP'),
        data_root='/workspace/mmdetection3d/data/nuscenes/',
        lidar_corruption='lidar_motionblur',
        metainfo=dict(classes=[
            'car',
            'truck',
            'construction_vehicle',
...
work_dir = './work_dirs/ADMN_multicorrupt_EE_test_lidar_motionblur/ADMN__EE_Controller_20'

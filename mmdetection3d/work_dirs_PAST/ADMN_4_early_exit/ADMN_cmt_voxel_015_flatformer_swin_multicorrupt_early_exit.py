...
custom_hooks = [
    dict(
        train_module_names=[
            'controller',
            'lidar_early_exit_transformer',
            'camera_early_exit_transformer',
        ],
...
model = dict(
    ...
    controller=dict(layer_budget=4, type='ConvLayerController'),
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        custom_keys=dict(
            camera_early_exit_transformer=dict(lr_mult=0.1),
            lidar_early_exit_transformer=dict(lr_mult=0.1))),
...
work_dir = './work_dirs/ADMN_4_early_exit/'

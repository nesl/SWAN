...
launcher = 'none'
load_from = './work_dirs//ADMN_model_6/epoch_3.pth'
log_level = 'INFO'
...
model = dict(
    controller=dict(layer_budget=6, type='ConvLayerController'),
...
work_dir = './work_dirs/ADMN_multicorrupt_test_camera_motionblur/ADMN_Controller_6'

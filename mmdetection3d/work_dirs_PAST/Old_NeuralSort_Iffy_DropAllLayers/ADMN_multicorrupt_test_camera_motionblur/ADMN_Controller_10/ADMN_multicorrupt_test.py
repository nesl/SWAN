...
launcher = 'none'
load_from = './work_dirs/ADMN_model_10/epoch_3.pth'
log_level = 'INFO'
...
model = dict(
    controller=dict(layer_budget=10, type='ConvLayerController'),
...
work_dir = './work_dirs/ADMN_multicorrupt_test_camera_motionblur/ADMN_Controller_10'

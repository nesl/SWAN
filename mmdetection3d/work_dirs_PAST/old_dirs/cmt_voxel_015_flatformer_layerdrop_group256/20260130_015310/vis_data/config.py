...
custom_hooks = [
    dict(disable_after_epoch=30, type='DisableObjectSampleHook'),
]
custom_imports = dict(
...
launcher = 'pytorch'
load_from = '/workspace/mmdetection3d/work_dirs/cmt_voxel_015_flatformer_layerdrop_group256/epoch_40.pth'
log_level = 'INFO'
...
work_dir = './work_dirs/cmt_voxel_015_flatformer_layerdrop_group256'

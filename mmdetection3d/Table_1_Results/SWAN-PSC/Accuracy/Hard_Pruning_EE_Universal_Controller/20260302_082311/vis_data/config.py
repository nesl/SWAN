...
launcher = 'none'
load_from = '/workspace/mmdetection3d/work_dirs/Hard_Pruning_EE_Universal_Controller/epoch_16.pth'
log_level = 'INFO'
...
model = dict(
    camera_early_exit_model=dict(type='Early_Exit_Camera_Mean'),
    ...
    lidar_early_exit_model=dict(type='Early_Exit_Lidar_Mean'),
    pts_backbone=dict(
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        custom_keys=dict(
            img_pruner=dict(lr_mult=1), lidar_pruner=dict(lr_mult=1))),
...
work_dir = './work_dirs/Hard_Pruning_EE_Universal_Controller'

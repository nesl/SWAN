...
launcher = 'none'
load_from = '/workspace/mmdetection3d/work_dirs/ADMN/ADMN_model_14/epoch_4.pth'
log_level = 'INFO'
...
model = dict(
    controller=dict(layer_budget=14, type='ADMNConvLayerController'),
...
work_dir = './work_dirs/ADMN_multicorrupt_camera_motionblur/ECCV_Controller_14'
